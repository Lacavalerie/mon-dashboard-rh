...
# Configuration
st.set_page_config(page_title="RH Cockpit Pro V64.1", layout="wide", initial_sidebar_state="expanded")
...
if rh is not None:
    ...
    # 6. GESTION BDD
        ...
        st.info(f"Vous modifiez les données du client : {st.session_state['company_name']}")
